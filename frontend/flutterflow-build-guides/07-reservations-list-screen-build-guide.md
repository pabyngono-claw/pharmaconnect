# PharmaConnect -- Reservations List Build Guide

**FlutterFlow build instructions for Screen 7/21**  
Role: **Patient**  
...
|---|---|---|---|
| `list_reservations` | `GET` | `/reservations` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `ReservationsListScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- [BACKEND GAP] GET /reservations is absent from the frozen Xano API specification.
