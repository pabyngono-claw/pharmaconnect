# PharmaConnect -- Respond to Request Build Guide

**FlutterFlow build instructions for Screen 13/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `create_pharmacy_response` | `POST` | `/responses` | Confirmed |
...
| Property | Value |
|---|---|
| Page name | `RespondToRequestScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- [BACKEND GAP] Frozen API does not support status, notes, ready time or per-item responses.
