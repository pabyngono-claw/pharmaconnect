# PharmaConnect -- Notifications Build Guide

**FlutterFlow build instructions for Screen 9/21**  
Role: **Patient**  
...
|---|---|---|---|
| `list_notifications` | `GET` | `/notifications` | BACKEND GAP |
| `mark_notification_read` | `POST` | `/notifications/{{notification_id}}/read` | BACKEND GAP |
| `mark_all_notifications_read` | `POST` | `/notifications/read-all` | BACKEND GAP |
...
- [BACKEND GAP] Notification endpoints are absent from the frozen Xano API specification.
