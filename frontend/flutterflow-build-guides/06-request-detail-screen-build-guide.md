# PharmaConnect -- Request Detail Build Guide

**FlutterFlow build instructions for Screen 6/21**  
Role: **Patient**  
...
|---|---|---|---|
| `get_request_detail` | `GET` | `/requests/{{request_id}}` | Confirmed |
...
- [BACKEND GAP] GET /requests/:id is confirmed. Reservation creation uses POST /reservations.
