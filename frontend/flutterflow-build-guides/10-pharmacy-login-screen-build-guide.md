# PharmaConnect -- Pharmacy Login Build Guide

**FlutterFlow build instructions for Screen 10/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `request_pharmacy_otp` | `POST` | `/auth/otp/request` | Confirmed |
| `verify_pharmacy_otp` | `POST` | `/auth/otp/verify` | Confirmed |

**Base URL:** Xano project environment variable.  
**Authorization:** None for public calls.  
...
- [BACKEND GAP] auth.verify-otp does not return role or pharmacy_id; add them or add a profile lookup.
