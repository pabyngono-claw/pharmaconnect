# PharmaConnect -- Pharmacy Notifications Build Guide

**FlutterFlow build instructions for Screen 19/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `list_pharmacy_notifications` | `GET` | `/notifications` | BACKEND GAP |
| `mark_pharmacy_notification_read` | `POST` | `/notifications/{{notification_id}}/read` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `PharmacyNotificationsScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
```text
Page (PharmacyNotificationsScreen)
+-- SafeArea
    +-- Stack
...
- [BACKEND GAP] Notification endpoints are absent.
