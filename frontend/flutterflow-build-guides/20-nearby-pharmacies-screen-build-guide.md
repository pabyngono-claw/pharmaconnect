# PharmaConnect -- Nearby Pharmacies Build Guide

**FlutterFlow build instructions for Screen 20/21**  
Role: **Public**  
...
|---|---|---|---|
| `get_nearby_pharmacies` | `GET` | `/pharmacies/nearby?lat={{lat}}&lng={{lng}}&radius_km={{radius_km}}&open_now={{open_now}}` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `NearbyPharmaciesScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- [BACKEND GAP] Public nearby endpoint is absent.
