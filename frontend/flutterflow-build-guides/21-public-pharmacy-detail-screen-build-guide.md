# PharmaConnect -- Public Pharmacy Detail Build Guide

**FlutterFlow build instructions for Screen 21/21**  
Role: **Public**  
...
|---|---|---|---|
| `get_public_pharmacy` | `GET` | `/pharmacies/{{pharmacy_id}}` | BACKEND GAP |
| `get_public_pharmacy_hours` | `GET` | `/pharmacies/{{pharmacy_id}}/hours` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `PublicPharmacyDetailScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
```text
Page (PublicPharmacyDetailScreen)
+-- SafeArea
    +-- Stack
    +-- Pharmacy header
    +-- Open/on-garde badge
...
- [BACKEND GAP] Public pharmacy detail and hours endpoints are absent.
