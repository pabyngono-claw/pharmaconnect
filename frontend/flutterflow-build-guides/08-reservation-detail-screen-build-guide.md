# PharmaConnect -- Reservation Detail Build Guide

**FlutterFlow build instructions for Screen 8/21**  
Role: **Patient**  
...
|---|---|---|---|
| `get_reservation_detail` | `GET` | `/reservations/{{reservation_id}}` | BACKEND GAP |
| `cancel_reservation` | `POST` | `/reservations/{{reservation_id}}/cancel` | Confirmed |
...
| Property | Value |
|---|---|
| Page name | `ReservationDetailScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- [BACKEND GAP] GET /reservations/:id is absent; cancel is confirmed.
