# PharmaConnect -- Inventory Build Guide

**FlutterFlow build instructions for Screen 18/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `list_inventory` | `GET` | `/inventory` | BACKEND GAP |
| `create_inventory_item` | `POST` | `/inventory` | BACKEND GAP |
| `update_inventory_item` | `PUT` | `/inventory/{{inventory_id}}` | BACKEND GAP |
| `adjust_inventory` | `POST` | `/inventory/adjust` | BACKEND GAP |
...
- [BACKEND GAP] Inventory endpoints are absent.
