# PharmaConnect -- Incoming Requests Build Guide

**FlutterFlow build instructions for Screen 12/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `get_incoming_requests` | `GET` | `/pharmacies/{{pharmacy_id}}/requests?status=sent` | Confirmed |
...
| Property | Value |
|---|---|
| Page name | `IncomingRequestsScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- No additional backend gap identified.
