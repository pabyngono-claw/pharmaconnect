# PharmaConnect -- Active Reservations Build Guide

**FlutterFlow build instructions for Screen 14/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `list_pharmacy_reservations` | `GET` | `/reservations?status=submitted,ready` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `ActiveReservationsScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
```text
Page (ActiveReservationsScreen)
+-- SafeArea
    +-- Stack
    +-- Header
    +-- Status chips
    +-- Ready priority section
    +-- Reservation list
...
- [BACKEND GAP] GET /reservations list is absent and must enforce pharmacy scoping.
