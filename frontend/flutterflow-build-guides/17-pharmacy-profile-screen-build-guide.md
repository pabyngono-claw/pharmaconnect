# PharmaConnect -- Pharmacy Profile Build Guide

**FlutterFlow build instructions for Screen 17/21**  
Role: **Pharmacy**  
...
|---|---|---|---|
| `get_pharmacy_profile` | `GET` | `/pharmacy/me` | BACKEND GAP |
| `update_pharmacy_profile` | `PUT` | `/pharmacy/me` | BACKEND GAP |
| `list_pharmacy_documents` | `GET` | `/pharmacy/me/documents` | BACKEND GAP |
| `upload_pharmacy_document` | `POST` | `/pharmacy/me/documents` | BACKEND GAP |
...
| Property | Value |
|---|---|
| Page name | `PharmacyProfileScreen` |
| Background | `#F8FAFC` |
| Safe area | Enabled |
...
- [BACKEND GAP] All pharmacy profile/document endpoints are absent.
